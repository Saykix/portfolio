<?php
    ...
    foreach($competence as $key){
        echo"<div class='$key[classCompetence] $key[classCompetence2]' >
                <img id=$key[identifiantCompetence] class='$key[classCompetence] $key[classCompetence2] logo' src=$key[logoCompetence] alt=$key[altCompetence]' draggable='true' ondragstart='drag(event)' >
            </div>";
    }
