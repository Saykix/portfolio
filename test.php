        ...
        <main>
            <div id='about'>
                ...
                <div id="skill">
                    <div id="hard" >
                        <h1>Hard Skills</h1>
                        <p id='dragText'>You can drag here my competencies</p>
                        <div id="dragHere" ondrop="drop(event)" ondragover="allowDrop(event)"></div>
                    </div>
                    <div id="lets">
                        <?php
                            include'skill.inc.php';
                        ?>
                    </div>
                    <div id="soft">
                        <h1>Soft skills</h1>   
                        <p id="drag1" draggable='true' ondragstart='drag(event)'>Persistent</p>
                        <p id="drag2" draggable='true' ondragstart='drag(event)'>Attentive</p>
                        <p id="drag3" draggable='true' ondragstart='drag(event)'>Autonomous</p>
                        <p id="drag4" draggable='true' ondragstart='drag(event)'>Serious</p>
                        <p id="drag5" draggable='true' ondragstart='drag(event)'>Diligent</p>
                    </div>
                </div>
